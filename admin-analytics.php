...
<head>
    ...
    <title>Analytics - Admin CampusHub</title>
    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="admin-analytics.php" class="active"><i class="bi bi-graph-up"></i> Analytics</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div>
                    <h1>Analytics</h1>
                    <p>Marketplace insights and detailed analytics</p>
                </div>
            </div>

            <div class="section-card" style="text-align: center; padding: 80px 30px;">
                <i class="bi bi-graph-up" style="font-size: 64px; color: #ccc; display: block; margin-bottom: 20px;"></i>
                <h3>Advanced Analytics</h3>
                <p class="text-muted">Detailed analytics dashboard with charts and metrics. Implementation coming soon!</p>
            </div>
        </main>
    </div>

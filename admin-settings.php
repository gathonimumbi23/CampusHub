...
<head>
    ...
    <title>Settings - Admin CampusHub</title>
    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="admin-settings.php" class="active"><i class="bi bi-gear"></i> Settings</a></li>
            </ul>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div>
                    <h1>Settings</h1>
                    <p>Configure marketplace settings and preferences</p>
                </div>
            </div>

            <div class="section-card" style="text-align: center; padding: 80px 30px;">
                <i class="bi bi-gear" style="font-size: 64px; color: #ccc; display: block; margin-bottom: 20px;"></i>
                <h3>Admin Settings</h3>
                <p class="text-muted">Configure marketplace settings, fees, and preferences. Implementation coming soon!</p>
            </div>
        </main>
    </div>
